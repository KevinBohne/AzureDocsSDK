...
keywords: Azure, javascript, SDK, API, @azure/arm-eventgrid, event-grid
ms.date: 07/24/2024
ms.topic: reference
ms.devlang: javascript
ms.service: event-grid
---
# Azure EventGridManagement client library for JavaScript - version 14.2.0-alpha.20240724.1 

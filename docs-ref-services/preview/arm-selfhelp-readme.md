...
ms.service: selfhelp
---
# Azure HelpRP client library for JavaScript - version 2.0.0-alpha.20240724.1 
...
[API reference documentation](/javascript/api/@azure/arm-selfhelp?view=azure-node-preview) |

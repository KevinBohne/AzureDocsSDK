...
---
# Azure bareMetalInfrastructure client library for JavaScript - version 1.0.0-alpha.20240726.1 
...
[API reference documentation](/javascript/api/@azure/arm-baremetalinfrastructure?view=azure-node-preview) |

---
title: Azure MicrosoftSecurityDevOps client library for JavaScript
keywords: Azure, javascript, SDK, API, @azure/arm-securitydevops, securitydevops
ms.date: 08/02/2024
ms.topic: reference
ms.devlang: javascript
ms.service: securitydevops
---
# Azure MicrosoftSecurityDevOps client library for JavaScript - version 1.0.0-alpha.20240801.1 
...
[API reference documentation](/javascript/api/@azure/arm-securitydevops?view=azure-node-preview) |

...
ms.service: sql
---
# Azure SqlManagement client library for JavaScript - version 11.0.0-alpha.20240801.1 
...
[API reference documentation](/javascript/api/@azure/arm-sql?view=azure-node-preview) |

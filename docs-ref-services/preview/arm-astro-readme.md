...
ms.service: astro
---
# Azure AstroManagement client library for JavaScript - version 1.0.0-alpha.20240801.1 
...
[API reference documentation](/javascript/api/@azure/arm-astro?view=azure-node-preview) |

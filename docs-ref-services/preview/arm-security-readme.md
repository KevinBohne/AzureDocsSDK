...
ms.service: security
---
# Azure SecurityCenter client library for JavaScript - version 6.0.0-alpha.20240725.1 
...
[API reference documentation](/javascript/api/@azure/arm-security?view=azure-node-preview) |

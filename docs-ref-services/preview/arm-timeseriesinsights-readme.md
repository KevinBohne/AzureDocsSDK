...
---
# Azure TimeSeriesInsights client library for JavaScript - version 2.1.0-alpha.20240724.1 
...
[API reference documentation](/javascript/api/@azure/arm-timeseriesinsights?view=azure-node-preview) |

...
ms.service: nginx
---
# Azure NginxManagement client library for JavaScript - version 4.0.0-alpha.20240726.1 
...
[API reference documentation](/javascript/api/@azure/arm-nginx?view=azure-node-preview) |

...
ms.service: monitor
---
# Azure Monitor client library for JavaScript - version 2.1.1-alpha.20240801.1 
...
[API reference documentation](/javascript/api/@azure/arm-monitor-profile-2020-09-01-hybrid?view=azure-node-preview) |

...
---
# Azure ResourceGraph client library for JavaScript - version 5.0.0-alpha.20240729.1 
...
[API reference documentation](/javascript/api/@azure/arm-resourcegraph?view=azure-node-preview) |

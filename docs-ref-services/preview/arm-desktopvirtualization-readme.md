...
---
# Azure Desktop Virtualization API client library for JavaScript - version 1.1.1-alpha.20240729.1 
...
[API reference documentation](/javascript/api/@azure/arm-desktopvirtualization) |

...
---
# Azure Visual Studio Resource Provider client library for JavaScript - version 4.0.0-alpha.20240725.1 
...
Use these APIs to manage Visual Studio Team Services resources through the Azure Resource Manager. All task operations conform to the HTTP/1.1 protocol specification and each operation returns an x-ms-request-id header that can be used to obtain information about the request. You must make sure that requests made to these resources are secure. For more information, see /rest/api/index.
...
[API reference documentation](/javascript/api/@azure/arm-visualstudio?view=azure-node-preview) |

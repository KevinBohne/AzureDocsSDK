...
---
# Azure ContainerService client library for JavaScript - version 20.1.0-alpha.20240724.1 
...
[API reference documentation](/javascript/api/@azure/arm-containerservice?view=azure-node-preview) |

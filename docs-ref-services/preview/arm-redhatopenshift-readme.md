---
title: Azure Red Hat OpenShift client library for JavaScript
keywords: Azure, javascript, SDK, API, @azure/arm-redhatopenshift, redhatopenshift
ms.date: 07/26/2024
ms.topic: reference
ms.devlang: javascript
ms.service: redhatopenshift
---
# Azure Red Hat OpenShift client library for JavaScript - version 1.0.0-alpha.20240726.2 
...
[API reference documentation](/javascript/api/@azure/arm-redhatopenshift?view=azure-node-preview) |
...
![Impressions](https://azure-sdk-impressions.azurewebsites.net/api/impressions/azure-sdk-for-js%2Fsdk%2Fredhatopenshift%2Farm-redhatopenshift%2FREADME.png)
